...
| BCR-02 — LGPD/jurídico | fonte administrativa singleton implementada; operador PJ/CNPJ, razão social, endereço parcial, representante parcial e canais iniciais foram declarados, mas nenhum registro real foi preenchido/validado | tratamento sem transparência, base ou responsabilidade comprovada | preencher e validar organização; comprovação institucional, identidade completa, termos/aviso, bases/LIA/RIPD, retenção e Encarregado | responsável humano + Privacy/Legal; terceiro qualificado quando exigido | cadastrar/validar no Admin e preparar/aprovar pacote LGPD M1 |
