...
| BCR-02 — LGPD/jurídico | operador PJ/CNPJ, razão social, endereço parcial, representante parcial e canais iniciais foram declarados; comprovação, endereço/representação completos, aviso, LIA/RIPD e retenção seguem pendentes | tratamento sem transparência, base ou responsabilidade comprovada | comprovação institucional aplicável, completar identidade, termos/aviso, bases/LIA/RIPD, retenção e Encarregado | responsável humano + Privacy/Legal; terceiro qualificado quando exigido | completar evidência organizacional e preparar/aprovar pacote LGPD M1 |
